        ...
        public static void Add()
        {
            try
            {
                ...
                using (SalonContext salonContext = new SalonContext())
                {
                    ...
                    //while (!listOfServiceIds.Contains(selectedServiceId))
                    //{
                    //    Console.WriteLine($"Service with ID {serviceId} doesnt found! Please enter a valid ID: ");
                    //    serviceId = Console.ReadLine();
                    //}
                    ...
                    //while (!listOfCustomerIds.Contains(selectedCustomerId))
                    //{
                    //    Console.WriteLine($"Service with ID {customerId} doesnt found! Please enter a valid ID: ");
                    //    customerId = Console.ReadLine();
                    //}
